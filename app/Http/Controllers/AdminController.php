...
class AdminController extends Controller
{
    ...
    public function AdminLoginSubmit(Request $request){
        ...
        if (Auth::guard('admin')->attempt($credentials)) {
            ...
            // ✅ PERBAIKAN: Redirect ke halaman login dengan pesan error
    ...
    public function AdminPasswordSubmit(Request $request) {
        ...
        $request_link = url('admin/reset-password/'.$token.'/'.$request->email);
        $subject = "Reset Password";
        $message = "Please click on below link to reset password<br>";
        $message.= "<a href='".$request_link."'>Click Here</a>";
